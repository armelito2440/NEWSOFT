...
class Facture(models.Model):
    ...
    prestation = models.ManyToManyField("Prestation")
    ...
    def pourPDF(cls, request, Facture_id):
        ...
        lst_det = PrestToFact.detail_ligne(fact=Facture_id)
...
class PrestToFact(models.Model):
    ...
    def detail_ligne(cls, fact):
        ...
        for p in lst:
            ...
            dct_detail['intitule'] =  p.prest.intitule
            dct_detail['prix_unitaire_HT'] = p.prix_unitaire_HT
            dct_detail['quantite'] =   p.quantite
            dct_detail['total_ligne'] = p.prix_unitaire_HT * p.quantite
            
            lst_detail.append(dct_detail.copy())
        return lst_detail    
